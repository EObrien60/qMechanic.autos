    ...
    <section className={styles.legal}>
      <div className={styles.container}>
        ...
        <div className={styles.content}>
          ...
          <p>
            By accessing or using the qMechanic mobile application and web platform (the &ldquo;Service&rdquo;), operated by
            OBH Software (&ldquo;we&rdquo;, &ldquo;our&rdquo;, or &ldquo;us&rdquo;), you agree to be bound by these Terms of Service. If you do not
          ...
          <h2>6. Your Data</h2>
          <p>
            You retain ownership of all data you submit to the Service (&ldquo;Your Data&rdquo;). By using the Service, you
          ...
          <p>
            ...
            posting the updated terms on this page and updating the &ldquo;Effective date&rdquo; above. Your continued use
