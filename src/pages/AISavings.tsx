...
export default function AISavings() {
  ...
  return (
    <>
      <SEO
        title="How AI Saves Workshops 15+ Hours a Week"
        description="See how AI-powered fleet management can save your workshop over 15 hours every week. Interactive breakdown of time savings across invoicing, compliance, analytics, and more."
        path="/ai"
      />
          ...
          <div className={styles.chatFeatureList}>
            <div className={styles.chatFeature}>
              ...
              <div className={styles.chatFeatureText}>
                ...
                <div className={styles.chatFeatureDesc}>"Which vehicles have unresolved defects?" — answered in seconds with a full breakdown.</div>
              </div>
            </div>
            <div className={styles.chatFeature}>
              <div className={styles.chatFeatureIcon}>
        ...
        <div className={styles.roiCard}>
          ...
          <div className={styles.roiRows}>
            <div className={styles.roiRow}>
              <span className={styles.roiLabel}>Admin labour (16 hrs x ~€20/hr)</span>
              <span className={styles.roiValue}>€320/wk</span>
            </div>
            <div className={styles.roiRow}>
              <span className={styles.roiLabel}>Missed compliance penalties</span>
              <span className={styles.roiValue}>€500+/yr</span>
            </div>
            <div className={styles.roiRow}>
              <span className={styles.roiLabel}>Invoice errors & duplicates</span>
              <span className={styles.roiValue}>€200/mo</span>
            </div>
            <div className={styles.roiRow}>
              <span className={styles.roiLabel}>Lost billable hours</span>
              <span className={styles.roiValue}>€400/wk</span>
            </div>
          </div>
        </div>
        ...
        <div className={`${styles.roiCard} ${styles.roiCardAccent}`}>
          ...
          <div className={styles.roiRows}>
            <div className={styles.roiRow}>
              ...
              <span className={`${styles.roiValue} ${styles.roiValueAccent}`}>~€145/mo</span>
            </div>
            <div className={styles.roiRow}>
          ...
          <div className={styles.roiTotal}>
            ...
            <span className={styles.roiTotalValue}>€2,400+</span>
          </div>
        </div>
      </div>
    </div>
