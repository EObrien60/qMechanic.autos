    ...
    <section className={styles.legal}>
      <div className={styles.container}>
        ...
        <div className={styles.content}>
          ...
          <p>
            qMechanic ("we", "our", or "us") is operated by OBH Software, based in Ireland. We are committed to
          ...
          <p>
            ...
            the updated policy on this page and updating the "Effective date" above. Your continued use of the
